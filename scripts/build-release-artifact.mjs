...
const LLMS_TASK_SECTIONS = Object.freeze([
  Object.freeze({
    ...
    pages: Object.freeze([
      ...
      ["/guides/uk-sim-at-heathrow/", "在希思罗机场按已有卡、待激活卡或现场购卡三种状态完成落地联网。"],
      ["/guides/manchester-student-sim/", "按曼彻斯特宿舍、校区与通勤地点比较手机卡和 giffgaff。"],
      ["/guides/london-student-sim/", "按伦敦住宿邮编、校区与地铁覆盖区段比较手机卡和 giffgaff。"],
